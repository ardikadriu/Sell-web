...
import Belt from "@/public/Belt.png";
import Perfume from "@/public/Parfume.png";
import Gloves from "@/public/gloves.png";

const Thirditems = () => {
  return (
    <div className="w-[1180px] flex  justify-around  shrink-0 mt-[201px]">
      <div
        className=" bg-[#F3F3F3] w-[289px] h-[448px] flex flex-col "
        id="Gloves"
      >
        <div className="flex w-[289x] justify-end mt-[14px] mr-[18px]">
          <svg
            width="24"
            height="21"
            viewBox="0 0 24 21"
